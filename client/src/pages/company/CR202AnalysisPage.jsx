...
const STREAMS = [
  { key: 'a', label: 'A', colClass: 'min-w-[76px] border-r border-slate-800/50' },
  { key: 'b', label: 'B', colClass: 'min-w-[76px] border-r border-slate-800/50' },
  { key: 'c', label: 'C', colClass: 'min-w-[76px] border-r border-slate-800/50' },
  { key: 'd', label: 'D', colClass: 'min-w-[76px] border-r border-slate-800/50' },
  { key: 'e', label: 'E', colClass: 'min-w-[76px] border-r border-slate-800/50' },
  { key: 'f', label: 'F', colClass: 'min-w-[76px] border-r border-slate-800/50' },
  { key: 'g', label: 'G', colClass: 'min-w-[76px] border-r border-slate-800/50' },
  { key: 'h', label: 'H', colClass: 'min-w-[76px] border-r border-slate-800/50' },
];
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-xs px-5 py-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="text-xs font-semibold text-slate-500">
            CNH₃ Streams (A - H) · 4-Hourly Intervals + AVG TCl, AVG A-H &amp; PCl
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-xs overflow-hidden">
        ...
        <div className="px-5 py-3 border-b border-slate-100 flex items-center justify-between bg-slate-50/80">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-extrabold text-slate-700 uppercase tracking-wider">
              CR 202 Analysis Data Entry (CNH₃ Streams, AVG TCl &amp; AVG A-H)
            </span>
          </div>
          ...
          <table className="w-full min-w-[850px] text-sm">
            ...
            <tbody className="divide-y divide-slate-200">
              {TIME_SLOTS.map((slot) => {
                ...
                return (
                  ...
                  >
                      ...
                      return (
                        <td key={stream.key} className="px-2 py-2.5 text-center align-middle">
                          <input
                            ...
                            className={`w-full max-w-[76px] mx-auto px-1.5 py-1.5 text-xs font-mono font-bold text-center rounded-lg transition-all focus:outline-none shadow-2xs ${
                              isInvalid
                    ...
                    {/* AVG TCl cell */}
                    <td className="px-2.5 py-2.5 text-center align-middle bg-slate-50/50">
                      <input
                    ...
                    <td className="px-2.5 py-2.5 text-center align-middle bg-slate-100/50">
                      <input
                        ...
                        className={`w-full max-w-[80px] mx-auto px-2 py-1.5 text-xs font-mono font-black text-center rounded-lg transition-all focus:outline-none shadow-2xs ${
                          errors[`${slot.key}_avgAH`]
                            ? 'border-2 border-red-500 bg-red-50 text-red-900 focus:ring-2 focus:ring-red-200'
                            : timeRows[slot.key].avgAH !== ''
                            ? 'border-2 border-emerald-500 bg-emerald-50 text-emerald-950 font-black focus:ring-2 focus:ring-emerald-200'
                            : 'border-2 border-slate-200 bg-slate-50 hover:border-slate-300 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100 text-slate-800'
                        }`}
                        aria-label={`AVG A-H at ${slot.time}`}
                        title="Average of streams A through H (Auto-calculated, editable)"
                      />
                    </td>
                  </tr>
                );
              ...
              <tr className="bg-sky-50/50 hover:bg-sky-100/60 border-t-2 border-sky-300 border-l-4 border-l-blue-600 transition-colors">
                ...
                {/* AVG TCl for PCl row */}
                <td className="px-2.5 py-3 text-center align-middle bg-slate-100/60">
                  <input
                    ...
                    className="w-full max-w-[80px] mx-auto px-2 py-1.5 text-xs font-mono font-bold text-center rounded-lg border-2 border-slate-300 bg-white hover:border-slate-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 text-slate-900 transition-all focus:outline-none shadow-2xs"
                    aria-label="PCl AVG TCl"
                  />
                </td>

                {/* AVG A-H for PCl row */}
                <td className="px-2.5 py-3 text-center align-middle bg-slate-100/80">
                  <input
                    ...
                    className="w-full max-w-[80px] mx-auto px-2 py-1.5 text-xs font-mono font-black text-center rounded-lg border-2 border-slate-300 bg-white hover:border-slate-400 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100 text-slate-900 transition-all focus:outline-none shadow-2xs"
                    aria-label="PCl AVG A-H"
                  />
                </td>
              </tr>
            </tbody>
        ...
        <div className="px-5 py-3 border-t border-slate-200 bg-slate-50/60 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-slate-500">
          <div className="flex items-center gap-2">
            ...
            <span>
              Values for <strong>CR 202 (CNH₃ Streams A - H)</strong>, <strong>AVG TCl</strong>, <strong>AVG A-H</strong> and <strong>PCl</strong>. Numeric values only.
            </span>
          </div>
          <div className="font-mono text-[11px] text-slate-400">
            Total Slots: 6 + 1 (PCl) · Live AVG A-H Calculation
          </div>
        </div>
      </div>
    </div>
