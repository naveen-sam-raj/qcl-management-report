...
const PARAMETERS = [
  { key: 'fnh3', label: 'FNH₃', unit: '', colClass: 'min-w-[110px] border-r border-slate-800/50' },
  { key: 'cnh3', label: 'CNH₃', unit: '', colClass: 'min-w-[110px] border-r border-slate-800/50' },
  { key: 'tcl',  label: 'TCl',  unit: '', colClass: 'min-w-[110px] border-r border-slate-800/50' },
  { key: 'pcl',  label: 'PCl',  unit: '', colClass: 'min-w-[110px] border-r border-slate-800/50' },
...
const TK203AnalysisPage = ({ plantId = 'acl' }) => {
  ...
  return (
    <div className="space-y-4 animate-fadeIn pb-6">
      ...
      {/* ── Date Selection & Shift Filter Card ──────────────────────────────── */}
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-xs px-5 py-3">
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-xs overflow-hidden">
        ...
        <div className="px-5 py-3 border-b border-slate-100 flex items-center justify-between bg-slate-50/80">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-extrabold text-slate-700 uppercase tracking-wider">
              TK 203 Analysis Data Entry (2-Hourly Intervals)
            </span>
          </div>
        </div>
        ...
        <div className="px-5 py-2.5 border-t border-slate-100 bg-slate-50/60 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-slate-500 font-medium">
            Values for <strong>TK 203</strong> (FNH₃, CNH₃, TCl, PCl, CO₂). Numeric values only. Leave blank if not applicable.
          </p>
          <div className="flex items-center gap-2">
            <button
              id="btn-tk203-save-bottom"
              onClick={handleSave}
              disabled={saving}
